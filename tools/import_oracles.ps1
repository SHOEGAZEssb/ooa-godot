...
Write-Host "Imported $($tilesets.Count) tilesets, 1536 rooms, 42 signs, $($npcRows.Count - 1) NPCs, $keeseInstanceCount Keese, $octorokInstanceCount Octoroks, $zolInstanceCount Zols, $gelInstanceCount direct Gels, 133 chests, 529 warps, 22 animation groups, and 223 sound IDs into $destination"
