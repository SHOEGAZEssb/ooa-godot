...
{
    public NpcRecord ToNpcRecord(int group, int room) => new(group, room, Id, SubId, Y, X, 0, 0, SpriteName, TileBase, Palette, 0, false, UpAnimation, RightAnimation, DownAnimation, LeftAnimation, string.Empty, NpcImplementationClassification.EventOwned);
}
