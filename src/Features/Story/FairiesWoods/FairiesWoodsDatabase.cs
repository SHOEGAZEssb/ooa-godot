        ...
        if (Event is not
            {
                ...
                CompletionFlag: GlobalFlag.WonFairyHidingGame,
                UnscrambledFlag: GlobalFlag.ForestUnscrambled,
                HiddenDelay: 12,
                ExitY: 0x28,
                ExitX: 0x9f,
                ExitRadiusY: 0x20,
                ExitRadiusX: 0x01,
                MagicSound: SoundId.SndMagicPowder,
                PuffSound: SoundId.SndPoof,
                MysterySound: SoundId.SndMysterySeed,
                NormalFadeOut: 32,
                NormalFadeIn: 33,
                FastFadeIn: 11,
                CompletionHold: 12,
