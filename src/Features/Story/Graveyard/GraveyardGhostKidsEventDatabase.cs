...
{
    public GraveyardGhostKidsEventDatabaseEventRecord Record { get; }
    public IReadOnlyList<GraveyardGhostKidsEventDatabaseTextRecord> Texts { get; }
    ...
    private static GraveyardGhostKidsEventDatabaseEventRecord LoadEvent()
    {
        ...
        return new GraveyardGhostKidsEventDatabaseEventRecord(
            row.Decimal(0, 0, 7),
            row.HexByte(1),
            row.HexByte(2),
            row.HexByte(3),
    ...
    private static IReadOnlyList<GraveyardGhostKidsEventDatabaseTextRecord> LoadTexts()
    {
        GeneratedTable table = GeneratedTable.Load(
            ...
            new GeneratedTableSchema(
                ...
                ["order"],
                headerRequired: true));
        var records = new List<GraveyardGhostKidsEventDatabaseTextRecord>();
        foreach (GeneratedTableRow row in table.Rows)
        {
            records.Add(new GraveyardGhostKidsEventDatabaseTextRecord(
