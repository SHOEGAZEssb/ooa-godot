...
{
    public NpcRecord ToNpcRecord(int group, int room, int y, int x) => new(group, room, InteractionId.GrassDebris, 0, y, x, 0, 0, SpriteName, TileBase, Palette, 0, false, Animation, Animation, Animation, Animation, string.Empty, NpcImplementationClassification.EventOwned);
}
