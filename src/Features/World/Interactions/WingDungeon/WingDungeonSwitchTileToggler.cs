...
internal sealed partial class WingDungeonSwitchTileToggler : Node2D,
    IRoomEntity, IFixedRoomEntity
{
    ...
    internal WingDungeonSwitchTileToggler(
        ObjectRecord record,
        OracleRoomData room,
        ...
        Func<long> animationTick)
    {
        ...
        Name = $"WingDungeonSwitchTile_{record.Room:x2}_{record.Order}";
    }
