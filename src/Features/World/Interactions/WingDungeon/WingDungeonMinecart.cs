...
/// </summary>
internal sealed partial class WingDungeonMinecart : SpiritsGraveVisualEntity,
    ...
    IPlayerRestriction, IPlayerForcedMovement
{
        ...
        Func<long> animationTick)
    {
        ...
        Name = cart.Riding
            ? $"WingDungeonMinecartRide_{cart.Room:x2}"
            : $"WingDungeonMinecart_{cart.Room:x2}_{cart.Slot}";
        ZIndex = 10;
        InitializeVisual(
            visual,
            Position,
    ...
    private void UpdateStationary(Player player)
    {
        ...
        WingDungeonMinecartState.BeginRide(
    ...
    private void UpdateRide(Player player)
    {
        ...
        {
            WingDungeonMinecartState.UpdateRide(
    ...
    {
        _slot = WingDungeonMinecartState.FinishRide(
    ...
    private bool TryBeginNeighborRoom(Vector2 previous)
    {
            ...
            !_rooms.TryGetNeighbor(4, _roomId, direction, out int neighbor))
        {
            throw new InvalidOperationException(
                $"Minecart in Wing Dungeon room 4:{_roomId:x2} crossed " +
    ...
    private int DirectionAwayFromPlatform()
    {
        ...
        throw new InvalidOperationException(
            $"Wing Dungeon minecart at 4:{_roomId:x2} " +
