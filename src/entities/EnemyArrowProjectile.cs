...
public partial class EnemyArrowProjectile : TransitionOffsetNode2D
{
    ...
    private EnemyDatabase.EnemyArrowRecord _record;
    ...
    internal void Initialize(
        EnemyDatabase.EnemyArrowRecord record,
        OracleRoomData room,
        Vector2 position,
        int angle)
    {
        ...
        OracleGraphicsCache.AnimationFrameDefinition frame =
        ...
        OracleGraphicsCache.AnimationFrameDefinition bounceFrame =
