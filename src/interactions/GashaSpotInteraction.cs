...
internal partial class GashaSpotInteraction : TransitionOffsetNode2D
{
    ...
    internal GashaSpotDatabase.SpotRecord Spot { get; private set; }
    ...
    internal void Initialize(
        ...
        GashaSpotDatabase.SpotRecord spot,
        OracleRoomData room,
        OracleSaveData save,
    ...
    internal void BeginReward(
        int rewardType,
        GashaSpotDatabase.RewardRecord reward,
        Player player)
    {
    ...
    private void SetVisual(GashaSpotDatabase.VisualRecord visual)
    {
