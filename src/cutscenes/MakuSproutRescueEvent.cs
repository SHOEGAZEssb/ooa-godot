...
{
    internal enum EventStage { Inactive, Running, NpcLoop, Completed }

    private readonly RoomEventContext _context;
    private readonly MakuSproutRescueDatabase _database = new();
    private readonly MakuSproutRescueDatabase.EventRecord _record;
    ...
    public bool HasState => _stage is EventStage.Running or EventStage.NpcLoop;
    ...
    {
        MakuSproutRescueDatabase.ActorRecord actor = _database.Actors["Sprout"];
    ...
    {
        MakuSproutRescueDatabase.ActorRecord actor = _database.Actors[actorName];
