...
internal sealed class BlackTowerDoorwayEvent : IRoomEntryEvent
{
    ...
    private readonly BlackTowerDoorwayEventDatabase.Record _record;
    ...
    public void UpdateFrame()
    {
        switch (_stage)
        {
            case EventStage.Initialize:
                Initialize();
                break;
            case EventStage.WaitForExit:
                if (!TouchesLink())
                    _stage = EventStage.Armed;
                break;
            case EventStage.Armed:
    ...
    public void Cancel() => _stage = EventStage.Inactive;
    ...
    private void Initialize()
    {
        ...
        _stage = TouchesLink() ? EventStage.WaitForExit : EventStage.Armed;
    }
