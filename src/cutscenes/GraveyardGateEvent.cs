...
internal sealed class GraveyardGateEvent : IRoomEntryEvent, ICutsceneCommandHost
{
    ...
    private readonly GraveyardGateEventDatabase.EventRecord _record;
    ...
    public bool HasState => _stage is EventStage.WaitingForKeyhole or EventStage.Running;
    public bool BlocksGameplay => _stage == EventStage.Running;
    ...
    internal GraveyardGateEventDatabase.EventRecord Record => _record;
    ...
    public void Start(OracleRoomData room)
    {
        ...
        _stage = EventStage.WaitingForKeyhole;
    }
    ...
    {
        if (_stage == EventStage.Completed)
    ...
    internal void Trigger(int group, int room)
    {
        ...
        _stage = EventStage.Running;
        _runner.Start(_database.Commands);
    }

    public void UpdateFrame()
    {
        if (_stage != EventStage.Running)
            return;
    ...
    private void RemoveGateTiles1()
    {
        ...
        foreach (GraveyardGateEventDatabase.InterleavedTile tile in
