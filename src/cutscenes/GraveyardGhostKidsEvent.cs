...
internal sealed class GraveyardGhostKidsEvent : IRoomEntryEvent
{
    ...
    private sealed class ChildLane(ChildRole role, NpcCharacter actor)
    {
    ...
    private readonly GraveyardGhostKidsEventDatabase.EventRecord _record;
    ...
    internal GraveyardGhostKidsEventDatabase.EventRecord Record => _record;
    ...
    {
        GraveyardGhostKidsEventDatabase.TextRecord text = _database.Texts[index];
