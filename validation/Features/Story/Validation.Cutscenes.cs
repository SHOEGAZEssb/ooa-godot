...
public sealed partial class ValidationRoot
{
    private void ValidateNewGameIntro()
    {
        ...
        if (intro.CurrentStage != Stage.WaitingForVoice ||
        ...
        intro.Update(1.0 / 60.0);
        if (intro.CurrentStage != Stage.Dialogue ||
            intro.StageFrame != 0 ||
            !screen.Dialogue.IsOpen ||
        ...
        intro.Update(1.0 / 60.0);
        if (intro.CurrentStage != Stage.Vanishing ||
            intro.StageFrame != 0 ||
        ...
        intro.Update(1.0 / 60.0);
        if (intro.CurrentStage != Stage.PostVanish ||
            intro.StageFrame != 0)
        {
            throw new InvalidOperationException(
    ...
    private void ValidateGraveyardGhostKidsCutscene()
    {
        ...
        if (ghostKids.GreenStage != ChildStage.Jumping ||
        ...
        StepRoomEventFrames(1);
        if (ghostKids.GreenStage != ChildStage.PostJumpWait ||
        ...
        StepRoomEventFrames(28);
        if (ghostKids.BlueStage != ChildStage.Jumping ||
        ...
        StepRoomEventFrames(1);
        if (ghostKids.RedStage != ChildStage.RedFreezeWait ||
        ...
        if (ghostKids.RedStage != ChildStage.RedTurnLeftWait ||
            ghostKids.RedCounter != record.RedFreezeWait ||
        ...
        StepRoomEventFrames(1);
        StepRoomEventFrames(record.RedPostTextWait);
        if (ghostKids.RedStage != ChildStage.RedTurnUpWait ||
            ghostKids.RedCounter != record.RedFreezeWait ||
        ...
        _dialogue.Close();
        StepRoomEventFrames(1);
        if (ghostKids.RedStage != ChildStage.RedFinalWait ||
        ...
        if (ghostKids.RedStage != ChildStage.Fleeing ||
        ...
        StepRoomEventFrames(1);
        if (ghostKids.RedStage != ChildStage.FleeEndPending ||
    ...
    private void ValidateEnterPastEvent()
    {
        ...
        if (enterPast.Counter != 1 || enterPast.Stage != EnterPastEventEventStage.PreJumpWait ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.BeginJump ||
            _sound.PlayRequestsFor(record.JumpSound) != 0)
        {
            throw new InvalidOperationException(
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.Jump ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.InstallPostJumpWait ||
        ...
        _dialogue.Close();
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.PostTextWait ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.StartFirstDown)
            throw new InvalidOperationException("setspeed SPEED_100 lost its script-command update.");

        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.FirstDown ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.Right ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.SecondDown ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.StartSlowDown ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.SlowDown ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.StartFinalDown ||
        ...
        StepRoomEventFrames(1);
        if (enterPast.Stage != EnterPastEventEventStage.FinalDown ||
        ...
        ValidationCutsceneTrace commandTrace)
    {
        ...
        if (impaEvent.CurrentStoneStage != StoneStage.AtStoneWait ||
        ...
        if (impaEvent.CurrentStoneStage != StoneStage.WaitingForPush ||
        ...
        StepRoomEventFrames(1);
        Input.ActionRelease("move_right");
        if (impaEvent.CurrentStoneStage != StoneStage.PushStarted ||
    ...
    private void ValidateMakuSproutRescueCutscene()
    {
        ...
        _sound.ClearPlayRequestAudit();
        LoadValidationRoom(group, roomId);
        if (!rescue.HasState || rescue.Stage != MakuSproutRescueEventEventStage.Running)
            throw new InvalidOperationException(
        ...
        if (rescue.HasState || rescue.Stage != MakuSproutRescueEventEventStage.Completed ||
