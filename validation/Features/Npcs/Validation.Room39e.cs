...
public sealed partial class ValidationRoot
{
    private void ValidateRoom39eInteractions()
    {
        ...
        if (ActiveActors() is not [var initial] ||
        ...
        _player.WarpTo(
            ...
            recordSafe: false);
        manager.Update(1.0 / 60.0, _player);
        if (initialImpa.FacingVector != Vector2I.Right)
        {
            throw new InvalidOperationException(
        ...
        _player.WarpTo(
            ...
            recordSafe: false);
        manager.Update(1.0 / 60.0, _player);
        if (initialImpa.FacingVector != Vector2I.Left)
        {
            throw new InvalidOperationException(
        ...
        if (ActiveActors() is not [var passage] ||
        ...
        _player.WarpTo(
            ...
            recordSafe: false);
        manager.Update(1.0 / 60.0, _player);
        if (passageImpa.FacingVector != Vector2I.Up)
        {
            throw new InvalidOperationException(
        ...
        if (passageImpa.FacingVector != Vector2I.Right ||
        ...
        if (ActiveActors() is not [var harp] ||
        ...
        if (ActiveActors() is not [var unrescuedZelda] ||
        ...
        if (!linkedImpa.Active || !zelda.Active ||
        ...
        if (!savedImpa.Active || !nayru.Active || !zelda.Active ||
        ...
        _player.WarpTo(
            ...
            recordSafe: false);
        manager.Update(1.0 / 60.0, _player);
        if (nayru.FacingVector != Vector2I.Right)
        {
            throw new InvalidOperationException(
                "Nayru did not run npcFaceLinkAndAnimate.");
        }
        ...
        {
            throw new InvalidOperationException(
                "The Maku Seed did not retire all room 3:9e story NPCs.");
        }

        Vector2 watchedTile = PackedCenter(0x32);
        if (room.GetMetatile(watchedTile) != 0x1c)
        {
            throw new InvalidOperationException(
        ...
        manager.Update(1.0 / 60.0, _player);
        if (!save.HasRoomFlag(group, roomId, OracleSaveData.RoomFlag80) ||
        ...
        if (persisted.GetMetatile(PackedCenter(0x31)) != 0x1c ||
