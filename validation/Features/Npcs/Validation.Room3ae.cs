...
public sealed partial class ValidationRoot
{
    private void ValidateRoom3aeInteractions()
    {
        ...
        try
        {
            ...
            if (harpEvent.Stage != HarpOfAgesEventStage.AwaitingPickup ||
                _roomEvents.Active ||
                harpEvent.Harp != harp ||
            ...
            _sound.Tick();
            if (harpEvent.Stage != HarpOfAgesEventStage.FadeOut ||
            ...
            StepRoomEventFrames(1);
            if (harpEvent.Stage != HarpOfAgesEventStage.BlackHold ||
            ...
            if (harpEvent.Stage != HarpOfAgesEventStage.NayruFlicker ||
            ...
            StepRoomEventFrames(1);
            if (harpEvent.Stage != HarpOfAgesEventStage.Script ||
            ...
            StepRoomEventFrames(1);
            if (harpEvent.CommandInstruction != 0 ||
            ...
            if (harpEvent.CommandInstruction != 5 ||
                nayru.CurrentScriptAnimationSource !=
            ...
            StepRoomEventFrames(1);
            StepRoomEventFrames(1);
            if (harpEvent.CommandInstruction != 7 ||
            ...
            if (harpEvent.CommandInstruction != 9 ||
            ...
            StepRoomEventFrames(1);
            if (harpEvent.CommandInstruction != 12 ||
                nayru.CurrentScriptAnimationSource !=
                    nayruVisual.Animation2)
            {
                throw new InvalidOperationException(
            ...
            StepRoomEventFrames(1);
            if (harpEvent.CommandCounter != 36)
                throw new InvalidOperationException(
                    "nayruScript07 did not install its post-song wait 36.");
            _sound.ClearPlayRequestAudit();
            ...
            StepRoomEventFrames(16);
            if (harpEvent.Stage != HarpOfAgesEventStage.FadeInTail ||
                _roomEvents.Active ||
                _player.CutsceneControlled ||
                !_hud.Visible ||
                _hud.StatusBarHidden ||
