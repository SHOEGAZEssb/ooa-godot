...
public sealed partial class ValidationRoot
{
    private void ValidateSkullZolSword()
    {
        ...
        foreach (string scenario in new[] { "green", "red", "red-lethal" })
        {
            ...
            FailIf(!_entities.TrySpawnEnemy(EnemyId.Zol, scenario == "green" ? 0 : 1, new Vector2(120, 80), "Skull Zol sword regression", out string error), error);
            ...
            FailIf(_sound.PlayRequestsFor(SoundId.SndKillEnemy) != 1,
