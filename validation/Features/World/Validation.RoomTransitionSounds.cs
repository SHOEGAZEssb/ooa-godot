...
public sealed partial class ValidationRoot
{
    private void ValidateRoomTransitionSounds()
    {
        ...
        foreach (int destination in new[] { 0, 1, 3, 4, 0x0e })
        {
            ...
            FailIf(_sound.PlayRequestsFor(SoundId.SndEnterCave) != expected,
            ...
            FailIf(_transitions.IsTransitioning ||
                _sound.PlayRequestsFor(SoundId.SndEnterCave) != expected,
        ...
        foreach (int mode in new[] { 0, 1, 2 })
        {
            LoadValidationRoom(0, 0x11);
            _sound.ClearPlayRequestAudit();
            var warp = new Warp(0, 0x11, -1, 0, WarpSourceTransition.FadeOut, 0, 0x12, 0x44, 0, WarpDestinationTransition.Basic,
            ...
            _transitions.UpdateWarp(180.0 / 60.0);
            FailIf(_transitions.IsTransitioning || _sound.PlayRequestsFor(SoundId.SndEnterCave) != 0,
