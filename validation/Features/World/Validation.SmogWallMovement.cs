...
public partial class ValidationRoot
{
    private void ValidateSmogWallMovement()
    {
        ...
        foreach (int subid in new[] { 2, 0x82 })
        {
            ...
            var move = new SmogWallMovement(data, subid, OracleObjectPosition.FromPixels(new(72,72)), 0, _ => 0);
        ...
        foreach (int subid in new[] { 2, 0x82 })
        {
            ...
            var move = new SmogWallMovement(data, subid, OracleObjectPosition.FromPixels(new(72,72)), 0, _ => collision);
        ...
        var wrapped = new SmogWallMovement(data, 2, OracleObjectPosition.FromPixels(new(8,8)), 0,
            packed => { reads.Add(packed); return 1; });
        wrapped.Update(_ => { });
